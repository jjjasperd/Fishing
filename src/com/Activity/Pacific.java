...
public class Pacific extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.arctic, menu);
		return true;
	}
	final Handler handler = new Handler(){          // handle  
        public void handleMessage(Message msg){  
            ...
            if(msg.what==1) {    
                ...
                if(recLen == 0){
   					new AlertDialog.Builder(Pacific.this)  
                	               .setTitle("时间到！")
                	               .setMessage("回到主界面！")
                	               .setPositiveButton("确定", new OnClickListener(){
                	            	   ...
                	            	   //跳回主界面
                							...
                							intent.setClass(Pacific.this, Main.class);
            		...
            		imageview.setOnTouchListener(new OnTouchListener() {
            			...
            			public boolean onTouch(View v, MotionEvent event) {
            				...
            				//显示钓到的鱼在这里
             	               ...
             	               .show();
            				Toast.makeText(Pacific.this, fish.getName(),
            				...
            				animationDrawable.start();
            					...
            					Toast.makeText(Pacific.this, "没钓到！",
                						Toast.LENGTH_SHORT).show(); 
